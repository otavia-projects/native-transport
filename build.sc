...
object ProjectInfo {
    ...
    def projectUrl: String      = "https://github.com/otavia-projects/native-transport"
    def github                  = VersionControl.github("otavia-projects", "native-transport")
...
object transport extends OtaviaModule {
    ...
    override def artifactName: T[String] = "otavia-native-transport"
